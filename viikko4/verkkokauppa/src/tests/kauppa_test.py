...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_ja_se_tarkastetaan(self):
        # alustetaan kauppa
        kauppa = Kauppa(self.varasto_mock, self.pankki_mock, self.viitegeneraattori_mock)
    ...
    def test_ostetaan_loppunutta_tuotetta(self):
        # alustetaan kauppa
        kauppa = Kauppa(self.varasto_mock, self.pankki_mock, self.viitegeneraattori_mock)
